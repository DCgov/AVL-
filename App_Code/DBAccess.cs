...
public class DBAccess : System.Web.Services.WebService
{
    ...
    [WebMethod(EnableSession = true)]
    [ScriptMethod(ResponseFormat = ResponseFormat.Json, UseHttpGet = true, XmlSerializeString = false)]
    public List<IMMarkerInfo> getIMmarkerInfo(string startTime, string endTime, string downloadAble, string patrolID)
    {
        return null;
        //DateTime startTime, endTime;
        ////double lat1, lat2, lng1, lng2;
        ////lat1 = 38.84616195784614;
        ////lat2 = 38.94342570475817;
        ////lng1 = -77.0866482543945;
        ////lng2 = -76.86760833740232;
        //Boolean downloadData=false;s
...
//        if(this.Context.Request.Params["downloadAble"] != null)
...
//        ////deleted spatial region, only focus on time period. 
//        //try
//        //{
//        //    lat1 = double.Parse(this.Context.Request.Params["lat1"].ToString());
//        //    lat2 = double.Parse(this.Context.Request.Params["lat2"].ToString());
//        //    lng1 = double.Parse(this.Context.Request.Params["lng1"].ToString());
//        //    lng2 = double.Parse(this.Context.Request.Params["lng2"].ToString());
//        //}
//        //catch (Exception e)
//        //{
//        //    lat1 = 38.84616195784614;
...
//        //debug purpose
//        //startTime = DateTime.Parse("2013-09-01");
//        //endTime = DateTime.Parse("2013-09-20");

//        // Create vars out of connection string and query string
//        string dbConn = ConfigurationManager.AppSettings["Tirsconn"];
//        //// Query All the attributes in the table.         

////        string dbQuery = @"SELECT top 80 * from [tirs].[dbo].[Incident_ddot] as a LEFT OUTER JOIN [tirs].[dbo].[Service_ddot] as b 
////        on a.IncID = b.incid where a.ddot_status=1 and a.ddot_longitude is not null and a.ddot_latitude is not null and a.ddot_StartDate >= '" + startTime.Date + "' and " +
////                                                                  "a.ddot_StartDate <= '" + endTime.Date + "' and " +
////                                                      "a.ddot_longitude >= " + (-1) * lng2 + " and a.ddot_longitude <= " + (-1) * lng1 + " and " +
////                                                      "a.ddot_latitude <= " + lat2 + " and a.ddot_latitude >= " + lat1;
//        string dbQuery = @"SELECT top 80 * from [tirs].[dbo].[Incident_ddot] as a LEFT OUTER JOIN [tirs].[dbo].[Service_ddot] as b 
//        on a.IncID = b.incid where a.ddot_status=1 and a.ddot_longitude is not null and a.ddot_latitude is not null and a.ddot_StartDate >= '" + startTime.Date + "' and " +
//                                                          "a.ddot_StartDate <= '" + endTime.Date + "'";
//        if (startTime.Date != DateTime.Now.AddDays(-20).Date || endTime.Date!=DateTime.Now.Date)
//        {
//            ////Consider the spatial information. 
////            // TOP 70
////            dbQuery = @"SELECT top 70 * from [tirs].[dbo].[Incident_ddot] as a LEFT OUTER JOIN [tirs].[dbo].[Service_ddot] as b 
////                    on a.IncID = b.incid where a.ddot_longitude is not null and a.ddot_latitude is not null and a.ddot_StartDate >= '" + startTime + "' and " +
////                                                                  "a.ddot_StartDate <= '" + endTime + "' and " +
////                                                      "a.ddot_longitude >= " + (-1) * lng2 + " and a.ddot_longitude <= " + (-1) * lng1 + " and " +
////                                                      "a.ddot_latitude <= " + lat2 + " and a.ddot_latitude >= " + lat1;

////            // TOP 70
//            dbQuery = @"SELECT top 70 * from [tirs].[dbo].[Incident_ddot] as a LEFT OUTER JOIN [tirs].[dbo].[Service_ddot] as b 
//        on a.IncID = b.incid where a.ddot_longitude is not null and a.ddot_latitude is not null and a.ddot_StartDate >= '" + startTime.Date + "' and " + "a.ddot_StartDate <= '" + endTime.Date +"'";
//            if (downloadData)
//            {
//                dbQuery = @"SELECT top 70 * from [tirs].[dbo].[Incident_ddot] as a LEFT OUTER JOIN [tirs].[dbo].[Service_ddot] as b 
...
//                                                                  "a.ddot_StartDate <= '" + endTime.Date + "' order by ddot_StartDate asc, ddot_DetctTime asc";
//            }
//        }
//        if(Patroller_id != null){ //temporary addededd
//            dbQuery += string.Format(" and ddot_patroller like '%{0}%'", Patroller_id.ToString());
//            dbQuery = dbQuery.Replace("top 70", "top 80");
//        }
//        // Connect to the database and run the query
//        SqlConnection conn = new SqlConnection(dbConn);
...
//        return obList;
    ...
    public class IMMarkerInfo
    {
        ...
        public IMMarkerInfo(int incID, string date, string time, string detctSrc, string othsrc, string direction, string otherdir, string actLights, string actSirens, string quadrant,
            ...
            string sceneDTime, double longitude, double latitude, string othAgency2, string imageAddress, string rNo, string hansenCPC, string hansenNo, string hansenCRC,
