...
public partial class SiteMaster : System.Web.UI.MasterPage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (HttpContext.Current.User.IsInRole("sysadmin") || HttpContext.Current.User.IsInRole("manager"))
        {
            NavigationMenu.Items.Add(new MenuItem("Operator Log", "Operator Log", null, "~/OperatorLog.aspx"));
        }
